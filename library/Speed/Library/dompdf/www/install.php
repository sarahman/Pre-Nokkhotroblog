...
<div id="toc">
    ...
    <ul>
        ...
        <ul>
            ...
            <ul><?php echo li_arrow() ?><a href="#load_font">
                <pre>load_font.php</pre>
            </a></li></ul>
...
<ul>
    ...
    <li style="list-style-image: url('images/star_05.gif');">Some fonts. PDFs
        ...
        See <a href="#fonts">below</a> for font installation instructions.
    </li>
    ...
    <li style="list-style-image: url('images/star_04.gif');">ttf2pt1 (available
        ...
        required to install new ttf fonts when using the CPDF backend.
    </li>
...
<ol>
    ...
    <li>Edit dompdf_config.inc.php to fit your installation. If you leave
        ...
        is installed, otherwise it will use the bundled R&amp;OS CPDF class.
    </li>
