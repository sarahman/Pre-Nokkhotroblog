    ...
    public function forgetAction()
    {
        ...
        if ($this->_request->isPost()) {
            ...
            if ($forgetPasswordForm->isValid($data)) {
                ...
                if (empty($result)) {
                    $this->redirectForFailure("/admin/auth/forget","Please enter correct email address.");
                    ...
                    $this->redirectForSuccess('/admin/auth/login', 'You have been sent an email for password recovery.');
                }
    ...
    public function resetPasswordAction()
    {
        ...
        if ($this->_request->isPost()) {
            ...
            if ($resetPasswordForm->isValid($data)) {
                ...
                $this->redirectForSuccess('/admin/auth/login', 'Your password has been reset successfully.');
            } else {
            ...
            if (empty($activeCode)) {
                $this->redirectForFailure('/admin/auth/forget', 'Something went wrong! Please re-enter your email address.');
            } else {
